  ...
  return (
    ...
    <Card sx={{ width: '100%', height: '250px', maxWidth: 445, maxHeight: '545px' }}>
      <CardActionArea sx={{ justifyContent: 'center', alignItems: 'center' }}>
        ...
        <CardActions sx={{marginTop:'40px',marginLeft:'center',marginRight:'center',alignItems:'center',justifyContent:'center'}}>
        <Button size="medium"  variant="contained" sx={{backgroundColor:'#00BBF6'}}>Connect</Button>
      </CardActions>
      </CardActionArea>
    </Card>
    </>
...
const RolesCards = () => {
  return (
    <>
      ...
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={{ xs: 1, sm: 2, md: 4 }}>
        <ActionAreaCard
          src={'https://leads.thedigitalsmith.co/img/Integration/sources/landingi.jpg'}
          title='Landigi'
        />
        <ActionAreaCard
        ...
        />
        <ActionAreaCard
        src={'https://leads.thedigitalsmith.co/img/Integration/sources/excel.png'}
        title='Excel' />
        <ActionAreaCard
